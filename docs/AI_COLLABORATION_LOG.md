...
|------|----------------|--------------|---------------|------------|
| 2026-05-21 | Judge terminal guide — README 20 curls, `curl-judge-terminal.sh`, HACKATHON; merged remote README banner/video | `448c7bd` | Hermes, Kiro, Cursor | docs, review |
